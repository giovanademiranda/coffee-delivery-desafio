...
export default function Home() {
  return (
    <div className="max-w-7xl w-full flex items-center justify-center p-4">
      <div className="flex w-full justify-center items-center">
        <div className="flex flex-col">
          <h1 className='w-[90%] font-baloo gap-4 text-title text-5xl font-extrabold leading-10'>Encontre o café perfeito para qualquer hora do dia</h1>
