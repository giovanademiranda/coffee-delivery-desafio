...
export default function Header() {
  return (
    <header className="flex max-w-7xl justify-between items-center p-5">
      <div className="flex">
        <Image data-cy="logo" src={Logo} alt="Logotipo" priority />
      </div>
      <nav className="flex items-center justify-center text-center">
        ...
        <Link data-cy="cart" href="/cart" className="flex relative p-2 justify-center items-center gap-1 m-2 rounded-md bg-yellow-light">
